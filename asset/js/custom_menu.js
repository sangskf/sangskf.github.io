//是否显示导航栏
    ...
    $(window).load(function () {
        var h1s = $(".article-content").find("h1");
        var h2s = $(".article-content").find("h2");
        var h3s = $(".article-content").find("h3");
        var h4s = $(".article-content").find("h4");
        var h5s = $(".article-content").find("h5");
        var h6s = $(".article-content").find("h6");
        ...
        $("body").prepend('<div class="BlogAnchor">' +
            '<span style="color:red;position:absolute;top:-6px;left:0px;cursor:pointer;" "$(\'.BlogAnchor\').hide();">×</span>' +
            '<p>' +
        ...
        var headerIDALL = [];
        var headerHightALL = [];
        $(".article-content").find("h1,h2,h3,h4,h5,h6").each(function (i, item) {
